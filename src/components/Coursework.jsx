    ...
    <div className="w-full text-white text-center -my-20">
      ...
      <div className="mt-10 grid grid-cols-1 sm:grid-cols-5 gap-4 text-lg">
        ...
        {[
          ...
          { id: 17, code: "EME 3813", name: "Technology-Enhanced Learning Environments", semester: "Summer 2025" },
          { id: 18, code: "ENC 3246", name: "Professional Communication for Engineers", semester: "Summer 2025" },
          { id: 19, code: "PHI 3681", name: "Ethics, Data, and Technology", semester: "Summer 2025" },
            { id: 20, code: "CIS 6261", name: "Trustworthy Machine Learning", semester: "Fall 2025" },
          { id: 21, code: "COP 4020", name: "Programming Language Concepts", semester: "Fall 2025" },
          { id: 22, code: "COP 4533", name: "Algorithm Abstraction and Design", semester: "Fall 2025" },
          { id: 23, code: "COP 4600", name: "Operating Systems", semester: "Fall 2025" },
          { id: 24, code: "EGS 4034", name: "Engineering Ethics and Professionalism", semester: "Fall 2025" },
          { id: 25, code: "QMB 3302", name: "Foundations of Business Analytics and Artificial Intelligence (AI)", semester: "Fall 2025" },
