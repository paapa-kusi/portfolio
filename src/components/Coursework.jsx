...
const Coursework = () => {
  const courses = [
    ...
    },
    {
      id: 19,
      code: "PHI 3681",
      name: "Ethics, Data, and Technology",
      semester: "Summer 2025",
      date: "2025-05",
      category: "Ethics",
      icon: <FaLightbulb />,
      color: "#8e44ad",
      description: "Ethical issues arising from the use of data and technology. Explores topics like privacy, security, and the social impact of technology.",
      syllabus: "SYLLABUS_LINK_HERE",
    },
    {
      id: 20,
    ...
    },
    {
      ...
      icon: <FaBook />,
      color: "#9b59b6",
      description: "Ethical and professional responsibilities of engineers. Covers codes of ethics, legal issues, and the impact of engineering on society.",
      syllabus: "SYLLABUS_LINK_HERE",
    },
    {
      id: 25,
